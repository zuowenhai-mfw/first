...
if($(".tooltip-demo").tooltip({selector:"[data-toggle=tooltip]",container:"body"}),$(".modal").appendTo("body"),$("[data-toggle=popover]").popover(),
	...
	//var gohome='<div class="gohome"><a class="animated bounceInUp" href="#/indexHome" title="返回首页"><i class="fa fa-home"></i></a></div>';
	//$("body").append(gohome)
}
